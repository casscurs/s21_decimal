...
//   s21_decimal z = {{0, 0, 0, 0}};
//   s21_add(x, y, &z);
//   char ourRes[1000], expect[1000] = "1000000001 1000000001 1000000001
//   655360"; snprintf(ourRes, sizeof(char) * 1000, "%u %u %u %u", z.bits[0],
//   z.bits[1],
//            z.bits[2], z.bits[3]);
//   ck_assert_str_eq(ourRes, expect);
// }
...
//   s21_decimal z = {{0, 0, 0, 0}};
//   s21_add(x, y, &z);
//   char ourRes[1000], expect[1000] = "2525163519 999999990 999999999
//   2148139008"; snprintf(ourRes, sizeof(char) * 1000, "%u %u %u %u",
//   z.bits[0], z.bits[1],
//            z.bits[2], z.bits[3]);
//   ck_assert_str_eq(ourRes, expect);
// }
...
//   s21_decimal z = {{0, 0, 0, 0}};
//   s21_add(x, y, &z);
//   char ourRes[1000], expect[1000] = "999999999 999999999 999999999
//   2148139008"; snprintf(ourRes, sizeof(char) * 1000, "%u %u %u %u",
//   z.bits[0], z.bits[1],
//            z.bits[2], z.bits[3]);
//   ck_assert_str_eq(ourRes, expect);
...
START_TEST(add_check) {
  ...
  // 79228162514264337593543950335+0.5=1
  // src1 = dec_max;
  // src2.bits[0] = 5;
  // src2.bits[1] = 0;
  // src2.bits[2] = 0;
